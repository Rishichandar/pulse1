...
server.get("/project_infouser", (req, res) => {
...
//   })
// });
// server.get("/task_details/:Email", (req, res) => {
...
server.get("/project_info1/:Title", (req, res) => {
...
//     let title = req.params.Title;
//     let query=`SELECT * FROM project_info WHERE Title=${title}`;
...
// Update data route
server.put('/api/update/:Email', (req, res) => {
